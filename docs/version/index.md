...
compact: "Routes release history from VERSION to one page per patch, keeping 0.9.59–0.9.62 flat and older patches in minor-version folders; includes dates, material summaries, historical group links, and planned follow-ups."
order: 1
---
...
- Date: 2026-09-14
- Summary: Added Campaign-specific automatic historical optimization, configurable similarity groups, threshold validation and algorithm tooltips.

## [0.9.58](0.9/0.9.58.md)

- Date: 2026-09-14
- Summary: Added bounded dashboard buffers with lazy refresh, shared concurrent loads and safe invalidation; verified the PostgreSQL Docker preview.

## [0.9.57](0.9/0.9.57.md)
...
## [0.9.55](0.9/0.9.55.md)

- Date: 2026-09-10
- Summary: Made the host deployment reproducible on a machine that keeps state between runs, so the snapshot tests read their fixtures rather than the machine's own pipeline artifacts and the synchronization step no longer keeps a stale recursive submodule checkout alive under `external/`

## [0.9.54](0.9/0.9.54.md)
...
## [0.9.37](0.9/0.9.37.md)

- Date: 2026-09-02
- Summary: Added canonical deep links for every dashboard subsection and route-owned, allow-listed lazy resources for live and static deployments, with cache reuse, reload invalidation, and browser history restoration

## [0.9.36](0.9/0.9.36.md)
...
## [0.9.35](0.9/0.9.35.md)

- Date: 2026-09-01
- Summary: Split large research observations from the core dashboard load, made Campaigns safe for 100,000 rows, exposed active schema inventory in protected Settings, documented versioned database migration/CD adoption, and made model runs select server-issued datasets

## [0.9.34](0.9/0.9.34.md)
