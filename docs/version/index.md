...
- Date: 2026-09-06
- Summary: Added the full lossless Data Generator configuration workflow, authoritative preflight, stale-response guards, static capability boundary, and bounded generator operations
