...
compact: "Routes release history from VERSION to one page per patch, keeping 0.9.37–0.9.40 flat and older patches in minor-version folders; includes dates, material summaries, historical group links, and planned follow-ups."
order: 1
---
