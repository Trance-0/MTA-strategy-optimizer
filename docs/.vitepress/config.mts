...
const sidebar = generateSidebar([
  ...
  {
    documentRootPath: ".",
    scanStartPath: "en/strategy_recommendation",
    resolvePath: "/en/strategy_recommendation/",
    useTitleFromFrontmatter: true,
    useFolderLinkFromIndexFile: true,
    collapsed: true,
    collapseFromLevel: 2,
    rootGroupText: "Strategy Recommendation",
    rootGroupLink: "/en/strategy_recommendation/",
  },
  {
    documentRootPath: ".",
...
const enTheme: DefaultTheme.Config = {
  ...
  nav: [
    ...
    { text: "Strategy Rec.", link: "/en/strategy_recommendation/" },
