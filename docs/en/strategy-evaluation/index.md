...
- The current [strategy initializer](../strategy/module-overview.md) is an unoptimized seed generator. The strategy evaluation framework does not change that — it provides the contract against which the initializer and future optimizers are both measured.
...
- [Strategy optimization model](../strategy/)
