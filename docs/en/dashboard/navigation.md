...
The optimizer optimization route also loads `research-campaigns` for its searchable
Campaign selector. Opening it directly requires no preselected Campaign query.
