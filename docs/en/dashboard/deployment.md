...
compact: "Dashboard launchers, Docker inputs and generated-data exclusions; canonical fixture provenance; static Pages assembly, build identity, publishing and deployment preflight."
lang: en-US
...
The Pages build runs `script/spec_docs.py check` before building either site.
Structural specification drift therefore blocks publication, as well as failing
the separate product verification workflow.
