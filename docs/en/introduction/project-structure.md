...
| `docs/en/<section>/` | Code-level specification, carried in the Source Files section of the page that describes the file; no separate implementation section exists | [Attribution](../attribution/index.md), [Strategy](../strategy-recommendation/module-overview.md), [Dashboard](../dashboard/index.md) |
