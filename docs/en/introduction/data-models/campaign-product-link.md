...
The linked [Campaign](./campaign.md)`.campaign_id`.
...
The linked [Product](./product.md)`.product_id`.
...
`campaign_id` references [Campaign](./campaign.md)`.campaign_id` by matching value, not by object reference.

### Relationship to Product

`product_id` references [Product](./product.md)`.product_id` by matching value, not by object reference.
