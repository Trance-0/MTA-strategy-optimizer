...
The current decision hierarchy is Campaign Group → Campaign → Ad Group.
...
## What Existing MTA Outputs Can Tell Us

Current MTA touchpoints are primarily composed of advertising fields, at the source attribution grain `AD_PRODUCT:FORMAT:PLACEMENT:CREATIVE:INTERACTION_TYPE`.
...
## What Other Relevant Data May Contain
...
## Main Breaks from MTA Touchpoints to Ad Group Budgets

### Touchpoint and Ad Group Granularity Differ
...
### Historical and Next-Period Structures Differ
...
### MTA Attribution Is Not Budget Incrementality

MTA explains historical outcome credit; it does not directly answer marginal-budget questions. The response model must answer two separate ones: how much actual Spend changes after a budget increase, and how conversions, purchases, or revenue change after Spend increases.
...
### Campaign-Level Contribution and Within-Campaign Differences
...
### Ad Group Count and Budget Allocation Affect Each Other
...
### Multiple Outcomes Do Not Have Identical Objectives
...
## Specific Problems Caused by Missing Product Information
