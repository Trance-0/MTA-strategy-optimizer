...
> 历史研究快照：本文记录 2026-07-06 当时的调研和实现建议，部分目录、输入结构与当前代码不同。当前行为以 [`modules/amc_mta`](../../../../modules/amc_mta/README.md) 和其[数据契约](../../../../modules/amc_mta/docs/amc-data-requirements.md)为准。
