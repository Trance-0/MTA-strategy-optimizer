...
- 策略初始化器说明固定在 `docs/en/strategy_recommendation/` 和 `docs/zh/strategy_recommendation/`，两个独立输入
...
- 策略模块的当前实现契约、结果复算说明和后续研究计划统一放在项目级
  `docs/en/strategy_recommendation/`；中文源文件保存在 `docs/zh/strategy_recommendation/`。研究计划必须明确标记为
