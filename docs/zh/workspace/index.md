...
3. [工作区文件位置管理](file-management.md)：新增、移动和归档文件。
...
7. [AMC MTA 能力评价](../product/amc-mta/capability-assessment.md)：深入判断归因能力。
...
| 代码结构与数据流 | [AMC MTA 架构](../product/amc-mta/architecture.md) |
| 项目成熟度与后续优先级 | [AMC MTA 能力评价](../product/amc-mta/capability-assessment.md) |
| Campaign Group 数据层级 | [Campaign Group 顶层数据关系与最细效果粒度](../research/campaign-data-hierarchy.md) |
| 尚未解决的 AMC MTA 技术问题 | `../../_bmad-output/implementation-artifacts/amc_mta/deferred/deferred-work.md` |
