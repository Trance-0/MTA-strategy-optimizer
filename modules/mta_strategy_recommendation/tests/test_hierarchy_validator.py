"""Tests for strategy input validation and budget initialization.

Covers hierarchy consistency, evidence SHA pinning, capacity rules, the equal
split inside a new Ad Group, and the boundary that keeps forbidden delivery
content out of the strategy output.
"""
