...
五份正式 CSV 位于 [`../outputs/attribution/`](../outputs/attribution/)。它们共享五段触点语义，但承担
...
可靠性字段。精确字段顺序见[治理规范](model-comparison-governance.md)。
...
输入、守恒和成本规则见[数据契约](amc-data-requirements.md)，完整审阅流程见
[完整使用说明](amc-mta-complete-guide.md)。
