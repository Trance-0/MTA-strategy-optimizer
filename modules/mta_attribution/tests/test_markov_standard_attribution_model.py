"""Tests for the independently packaged standardized Markov model."""
...
class MarkovStandardAttributionModelTests(unittest.TestCase):
    """Verify the Markov model through only its public standard contract."""
    ...
    def test_emits_valid_standard_rows(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            rows = MarkovRemovalEffectModel().attribute(dataset)
