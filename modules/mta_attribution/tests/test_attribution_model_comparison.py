"""Tests for model comparison, reliability judgement, and atomic publication.

Covers the three-criterion reliability contract, gap and distance metrics, the
recommended-value fallback to a model interval, and the CSV set writer's
guarantee that a failed publication restores the complete prior artifact set.
"""
